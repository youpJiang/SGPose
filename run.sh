CUDA_VISIBLE_DEVICES=2 python3 run_adaptpose.py --note poseaug --posenet_name 'videopose' --lr_p 1e-4 \
...
--df 6 --tg 5 --debug false --warmup 5 --epochs 50 --attention true --mixtrain true  \
 --decay_epoch 0 --ours2 true --psudo_root false --batch_size 1024