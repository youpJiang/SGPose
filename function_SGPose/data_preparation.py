...
def data_preparation(args,remove_static_joints=True):
    ...
    dataset_path = '/home/jyp/proj/AdaptPose/data/data_3d_h36m.npz'
    ...
    keypoints = create_2d_data('/home/jyp/proj/AdaptPose/data/data_2d_h36m_gt.npz', dataset,tag=args.dataset_target)
    ...
    print("h36m train:" , len(poses_train))
    print("h36m test:" , len(poses_valid))
    ...
    if args.dataset_target == '3dhp':
        keypoints_target = create_2d_data_target('/home/jyp/proj/AdaptPose/data/data_3dhp_gt_train.npz', dataset)
        ...
        poses_target_3d = fetch_3dhp_train('/home/jyp/proj/AdaptPose/data/data_3dhp_gt_train_3d.npz')
    ...
    if args.dataset_target == '3dhp' or args.dataset_target =='h36m':
        ...
        keypoints_test=create_2d_data_3dhp_test('/home/jyp/proj/AdaptPose/data/data_3dhp_gt_test.npz')
        mpi3dhp_3d,mpi3dhp_2d=fetch_3dhp('/home/jyp/proj/AdaptPose/data/data_3dhp_gt_test.npz',keypoints_test)
    ...
    # print("h36m trainset len: " , len(poses_train))
    # print("h36m testset len: " , len(poses_valid))
    # print("3dhp trainset len: " , len(poses_target_2d))
    # print("3dhp testset len: " , len(mpi3dhp_3d))
    print("3dpw trainset len: " , len(poses_target_2d))
    print("3dpw testset len: " , len(_3dpw_3d))
    exit()
    return {
        'dataset': dataset,
