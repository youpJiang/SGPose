...
def get_parse_args():
    ...
    parser.add_argument('--ours2', default=False, type=lambda x: (str(x).lower() == 'true'), help='global position')
    parser.add_argument('--psudo_root', default=False, type=lambda x: (str(x).lower() == 'true'), help='global position in psudoroot')
    parser.add_argument('--attention', default=False, type=lambda x: (str(x).lower() == 'true'), help='attention')
    parser.add_argument('--debug', default=False, type=lambda x: (str(x).lower() == 'true'), help='train S1 only')
    parser.add_argument('--mixtrain', default=False, type=lambda x: (str(x).lower() == 'true'), help='fake data and true data 1:1 traning')
    ...
    parser.add_argument('--tg', default=50, type=int, help='epoch tran GAN')
