...
def data_preparation(args,remove_static_joints=True):
    ...
    dataset_path = '/home/jyp/projects/AdaptPose_mine/data/data_3d_h36m.npz'
    ...
    keypoints = create_2d_data('/home/jyp/projects/AdaptPose_mine/data/data_2d_h36m_gt.npz', dataset,tag=args.dataset_target)
    ...
    if args.dataset_target == '3dhp':
        keypoints_target = create_2d_data_target('/home/jyp/projects/AdaptPose_mine/data/data_3dhp_gt_train.npz', dataset)
        ...
        poses_target_3d = fetch_3dhp_train('/home/jyp/projects/AdaptPose_mine/data/data_3dhp_gt_train_3d.npz')
    ...
    if args.dataset_target == '3dhp' or args.dataset_target =='h36m':
        ...
        keypoints_test=create_2d_data_3dhp_test('/home/jyp/projects/AdaptPose_mine/data/data_3dhp_gt_test.npz')
        mpi3dhp_3d,mpi3dhp_2d=fetch_3dhp('/home/jyp/projects/AdaptPose_mine/data/data_3dhp_gt_test.npz',keypoints_test)
